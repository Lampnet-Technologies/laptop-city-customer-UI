  ...
  return (
    <div className="space-y-6 lg:space-y-7">
      ...
      <div className="space-y-3 font-normal lg:text-lg lg:leading-[30px]">
        <p>
          Thank you for accessing the Laptop City website. We respect your
          privacy and want to protect your personal information. To learn more,
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 font-normal lg:text-lg lg:leading-[30px]">
          <p>
            We will use the information you provide to enable us to better
            provide you with the services and information offered through our
            website and which you request. Further, we will use the information
            you provide to administer your account with us; audit the
          ...
          <p>
            We may also send you other information about us, the website, our
            products, sales promotions, our newsletters, anything relating to
            other companies in our group or our business partners. If you would
            prefer not to receive any of this additional information as detailed
            in this paragraph (or any part of it) please click the 'unsubscribe'
            link in any email that we send to you.
          </p>
          <p>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 font-normal lg:text-lg lg:leading-[30px]">
          <p>
            ...
            Policy or unless we are required to do so by law.
          </p>
          <p>
            The Site may contain advertising of third parties and links to other
            ...
            your data in accordance with our Privacy Policy. Some of the
            advertisements you see on the Site are selected and delivered by
            third parties, such as ad networks, advertising agencies,
            ...
            Please remember that we do not have access to, or control over, the
            information these third parties may collect. The information
            practices of these third parties are not covered by this privacy
            policy.
          </p>
          <p>
            Laptop City uses Google API Services to provide users with content
            related to products. For more information about Google privacy
            policy visit{" "}
            <Link
      ...
      <section className="space-y-4">
        <h3 className="text-2xl text-gray-700 lg:text-[28px]">Security</h3>
        ...
        <div className="space-y-3 font-normal lg:text-lg lg:leading-[30px]">
          <p>
            ...
            server. We use firewalls on our servers. We maintain physical,
            electronic and procedural safeguards in connection with the
            collection, storage and disclosure of your information. You are
      ...
      <section className="space-y-4">
        <h3 className="text-2xl text-gray-700 lg:text-[28px]">Your rights</h3>
