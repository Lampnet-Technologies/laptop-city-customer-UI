    ...
    <>
      ...
      <div className="hidden lg:block w-full space-y-14 ml-24">
        <div className="border border-solid border-green rounded w-full">
          <div className="border-b border-b-solid border-b-gray-400 text-center font-semibold capitalize text-2xl py-6 px-[75px]">
            account details
          </div>
          <div className="flex justify-between items-center gap-4 py-8 px-[75px]">
